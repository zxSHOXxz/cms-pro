...
Route::prefix('admin')->middleware(['auth:web,client', 'ActiveAccount'])->name('admin.')->group(function () {
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::get('purchases_create/{id}', [PurchaseController::class, 'createPurchase'])->name('purchases_create');
